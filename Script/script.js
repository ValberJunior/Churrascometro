...
function calcular(){
    ...
    resultado.innerHTML = `<p onmouseover="clickOn(this)" onmouseout="clickOut(this)">${Math.ceil(((qtdTotalCarne / 100)* 70)/1000)} Kg de Carne</p>`;
    ...
    resultado.innerHTML += `<p onmouseover="clickOn(this)" onmouseout="clickOut(this)">${Math.ceil(((qtdTotalCarne / 100)* 20)/1000)} Kg de Linguiça</p>`;                                //Adicionando o resultado no html
